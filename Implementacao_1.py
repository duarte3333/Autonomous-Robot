# -*- coding: utf-8 -*-
"""
Created on Sat Dec 19 03:21:32 2020
...
def RunBotao_first(cor_roboat, cor_proa, tempo_limpeza):
        
        """Esta função irá correr a primeira implementação"""
        ...
        #Criação das Impurezas e das Ilhas em ambiente gráfico

        a = lista_pontos_det_imp1(lista_pontos_ilhas,window)
        ...
        #O Roboat irá mover-se até ao centro de cada impureza e demorar um determinado tempo a limpar cada impureza
