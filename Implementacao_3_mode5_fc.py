# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 14:45:24 2020
...
#Função que irá correr a terceira implementação
     
def RunBotao_third_mode5(tempo_limpeza, cor_proa, cor_roboat):
    
        """Esta função irá correr a terceira implementação, de modo que as impurezas serão geradas
        através de cliques no rato as ilhas sejam geradas a partir de um ficheiro txt"""
        
        #Ver no documento "Functions_ficheiros_aleatorios" a descrição detalhada da função
