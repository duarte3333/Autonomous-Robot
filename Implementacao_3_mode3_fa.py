# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 04:20:38 2020
...
def RunBotao_third_mode3(tempo_limpeza, cor_proa, cor_roboat):
    
        """Esta função irá correr a terceira implementação, de modo que as impurezas serão geradas aleatóriamente e as ilhas sejam geradas a partir de um ficheiro txt"""
        ...
        a = impurezas_aleatorias(c1,window) 
