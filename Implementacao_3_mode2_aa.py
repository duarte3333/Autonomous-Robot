# -*- coding: utf-8 -*-
"""
Created on Mon Dec 21 04:32:42 2020
...
def RunBotao_third_mode2(tempo_limpeza, cor_proa, cor_roboat):
    
        """Esta função irá correr a terceira implementação, de modo que tanto as impurezas como as ilhas sejam geradas aleatóriamente"""
        ...
        a = impurezas_aleatorias(a1,window)
